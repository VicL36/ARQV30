...
class PDFReportGenerator:
    ...
    def generate_pdf_report(self, data: dict, filename: str):
        ...
        story.append(Paragraph("\u00a0\u00a0\u00a0\u00a0\u2022 \u00a0Personalidade: O tom da comunicação, a escolha de palavras e a forma como o avatar reage a desafios podem indicar traços de personalidade como \"proativa\", \"ambiciosa\" ou \"analítica\".", self.styles['ListText']))
